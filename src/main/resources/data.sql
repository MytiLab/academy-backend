...
VALUES (1, 'logistic@galbanino.it', 'ciaociao123', 'Logistica Galbanino');

INSERT INTO tipologie_eventi (`id`, `nome`, `descrizione`)
VALUES (1, 'EVENTO PRATICLE', 'Evento proveniente da Particle'),
       (2, 'EVENTO HANNIBAL', 'Evento proveniente da Hannibal');

INSERT INTO stati_unita_logistiche (`id`, `nome`, `descrizione`)
VALUES (1, 'NORMALE', 'Unità funzionante che può essere usata'),
       (2, 'ROTTA', 'Unità rotta'),
...
VALUES (1, 'TRAIN_AAAA', '2019-02-01', 'BRESCIA', '2020-02-03', 'MILANO');
...
VALUES (1, '2019-02-01 10:30:04', 2, 1, 2),
...
VALUES (2, 2.1, 80.6, 0, 45.556556, 10.216596, 100),
...
INSERT INTO contenuti (`id`, `nome`, `descrizione`, `temperatura_minima_ricchiesta`, `temperatura_massima_ricchiesta`,
                       `quantita`, `unita_di_misura`, `collo_id`)
VALUES (1, 'CAVOLO CAPPUCCIO', 'Detto anche verza', 2, 5, 10, 'kg', 1),
